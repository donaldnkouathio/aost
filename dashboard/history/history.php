...
?>
  ...
  <div class="suggest_block" style="border-color : <?php echo $color; ?>;">
    ...
    <div class="suggest_row">
      <span class=""  style="max-width: 100%; min-height: 6em; display: inline-block;font-weight:bold" title="<?php echo ucfirst(htmlspecialchars_decode(str_replace("&amp;","&",$history->getDescription()))); ?>"> <?php echo ucfirst(htmlspecialchars_decode(str_replace("&amp;","&",$history->getDescription()))); ?></span>
    </div>
    <div class="suggest_row">
