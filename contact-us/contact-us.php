<div class="offset-10-laptop contacteznous-block">
  ...
  <div class="left">
    ...
    <p class="margin-top-none">
      ...
      <a style="" class="notranslate" href='mailto:info@alphaomegasolutionstravail.ca'> Info@alphaomegasolutionstravail.ca (Informations)</a>
      <br>
      <span class="notranslate material-icons vertical-align-bottom margin-right-5 background-primary">email</span>
      <a style="" class="notranslate" href='mailto:rh@alphaomegasolutionstravail.ca'> RH@alphaomegasolutionstravail.ca (Demande d'emploi)</a>
      <br>
      <span class="notranslate material-icons vertical-align-bottom margin-right-5 background-primary">email</span>
      <a style="" class="notranslate" href='mailto:paie@alphaomegasolutionstravail.ca'> Paie@alphaomegasolutionstravail.ca (Paie)</a>
      <br>
      <span class="notranslate material-icons vertical-align-bottom margin-right-5 background-primary">email</span>
      <a style="" class="notranslate" href='mailto:dr@alphaomegasolutionstravail.ca'> DR@alphaomegasolutionstravail.ca (Directeur)</a>
      <br>
      <span class="notranslate material-icons vertical-align-bottom margin-right-5 background-primary">email</span>
      <a style="" class="notranslate" href='mailto:partenaires@alphaomegasolutionstravail.ca'> Partenaires@alphaomegasolutionstravail.ca (Partenaires)</a>
    </p>


    <h2 class="margin-bottom-none">Réseaux sociaux</h2>
    <p class="margin-top-none">
      <a href="https://www.facebook.com/ALPHA-OMEGA-Solutions-Travail-AOST-120693572651635/" target="_blank">Page Facebook</a>
    </p>
