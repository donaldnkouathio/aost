...
<div class="offset-10-laptop about-block">
  ...
  <div class="about-contain">
    ...
    <ul>
      ...
      <li><i class="material-icons vertical-align-bottom"> check_circle </i>	Un conseiller vous contactera dès la réception de votre demande de manière à dresser un portrait exhaustif de votre entreprise et de vos besoins</li>
    </ul>
...
<div class="container-box" style="background-image: url('<?php echo _ROOT_PATH; ?>img/bg/bg4.jpg');">
  <div class="container-box-shadow">
    <div class="offset-10-laptop container-box-body">
      <div class="container-title container-text_1-title">Vous chercher un emploi ? </div>
...
<div class="offers-container">
  <div class="offset-10-laptop emplois-populaires">
    ...
    <a href="<?php echo _ROOT_PATH; ?>job/offers/" class="ep-voir-plus">VOIR TOUS LES EMPLOIS DISPONIBLES <i class="material-icons vertical-align-bottom"> chevron_right </i></a>
  </div>
</div>
